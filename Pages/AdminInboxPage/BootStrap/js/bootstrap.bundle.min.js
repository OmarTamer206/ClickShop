...
!(function (t, e) {
    ...
    class xt extends W {
        ...
        _addTouchEventListeners() {
            ...
            const t = {
                leftCallback: () => this._slide(this._directionToFeedback(ct)),
                rightCallback: () => this._slide(this._directionToFeedback(ht)),
                endCallback: () => {
                    "hover" === this._config.pause &&
                        (this.pause(),
        ...
        _keydown(t) {
            ...
            const e = Tt[t.key];
            e &&
                (t.preventDefault(), this._slide(this._directionToFeedback(e)));
        }
        _getItemIndex(t) {
            ...
            const o = this._getItemIndex(s),
                r = (e) =>
                    N.trigger(this._element, e, {
                        relatedTarget: s,
                        direction: this._FeedbackToDirection(t),
        ...
        _directionToFeedback(t) {
            return p() ? (t === ct ? lt : at) : t === ct ? at : lt;
        }
        _FeedbackToDirection(t) {
            ...
            var s,
                ...
                h = {
                    ...
                    setOptions: function (i) {
                        ...
                        return (
                            (a.FeedbackedModifiers = u.filter(function (t) {
                                return t.enabled;
                            })),
                            a.FeedbackedModifiers.forEach(function (t) {
                                var e = t.name,
                                    i = t.options,
                                    n = void 0 === i ? {} : i,
                                    s = t.effect;
                    ...
                    forceUpdate: function () {
                        if (!c) {
                            ...
                            if (pi(e, i)) {
                                ...
                                for (
                                    var n = 0;
                                    n < a.FeedbackedModifiers.length;
                                    n++
                                )
                                    if (!0 !== a.reset) {
                                        var s = a.FeedbackedModifiers[n],
                                            o = s.fn,
                                            r = s.options,
                                            l = void 0 === r ? {} : r,
                                            d = s.name;
